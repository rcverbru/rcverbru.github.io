...
[PDF Version](../files/ryan_verbrugge_cv.pdf)
...
__Major AutoDrive Contributions:__
...
- LiDAR Based Localization System (See [github.com](https://github.com/rcverbru/divining-rod))
    - In year 4 of the AutoDrive II Challenge, teams were put to the task of navigating through an environment with intermittent GPS signal drops. With this challenge in mind, I was assigned the task of building the new localization system from scratch for our team. To do this, I worked on making an adaptation of [KISS-ICP](https://www.ipb.uni-bonn.de/wp-content/papercite-data/pdf/vizzo2023ral.pdf), which is a simple ICP based localization system, as a way to solve this challenge. The aim was to make a lightweight localization system so that we can successfully detect where we are within our environment and navigate to our end-goal location safely.
